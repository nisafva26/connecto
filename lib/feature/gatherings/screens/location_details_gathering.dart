...
class LocationDetailsGatheringScreen extends StatefulWidget {
  ...
  @override
  State<LocationDetailsGatheringScreen> createState() =>
      _LocationDetailsGatheringScreenState();
}

class _LocationDetailsGatheringScreenState
    extends State<LocationDetailsGatheringScreen> {
  int currentPage = 0;
